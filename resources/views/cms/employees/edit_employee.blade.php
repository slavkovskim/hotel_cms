                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 text-center">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label>Male</label>
                                    <input class="form-control" type="radio" {{ ( $employe->works_at == 0) ? 'checked' : '' }} name="gender" value="0" />
                                </div>
                                <div class="col-md-6">
                                    <label>Female</label>
                                    <input class="form-control" type="radio" {{ ( $employe->works_at == 1) ? 'checked' : '' }} name="gender" value="1" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
